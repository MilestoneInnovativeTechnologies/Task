...
class ResourceListScopeTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\ResourceListScope::query()
            ...
            ->create([	'id' => '802308', 	'resource_list' => '802214', 	'scope' => '800705', 													])
            ->create([	'id' => '802309', 	'resource_list' => '802214', 	'scope' => '800708', 													])
            ->create([	'id' => '802310', 	'resource_list' => '802215', 	'scope' => '800705', 													])
            ->create([	'id' => '802311', 	'resource_list' => '802215', 	'scope' => '800709', 													])
        ;
