...
class ResourceActionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\ResourceAction::query()
            ->create([	'id' => '803201', 	'resource' => '800501', 	'name' => 'CreateFormAction', 	'description' => 'Action to call group create form', 			'menu' => 'Create Group', 									])
            ->create([	'id' => '803202', 	'resource' => '800501', 	'name' => 'ListGroupsAction', 	'description' => 'Action to call list to list groups', 			'menu' => 'List All Groups', 									])
            ...
            ->create([	'id' => '803204', 	'resource' => '800501', 	'name' => 'ListPartnerAction', 	'description' => 'Action to call list to list all partners', 			'menu' => 'List All Partners', 									])
            ...
            ->create([	'id' => '803206', 	'resource' => '800501', 	'name' => 'ManageGroupPartners', 	'description' => 'Action to manage group partners', 	'title' => 'Manage Partners', 											])
            ->create([	'id' => '803207', 	'resource' => '800506', 	'name' => 'CreateTaskAction', 	'description' => 'Action to call form to create task', 			'menu' => 'New Task', 									])
            ->create([	'id' => '803208', 	'resource' => '800506', 	'name' => 'ListTaskAction', 	'description' => 'Action to call list to list all tasks', 			'menu' => 'List All Tasks', 									])
            ...
            ->create([	'id' => '803228', 	'resource' => '800501', 	'name' => 'EditPartnerFormAction', 	'description' => 'Action to edit users', 	'title' => 'Update Partner', 											])
            ->create([	'id' => '803229', 	'resource' => '800501', 	'name' => 'EditGroupFormAction', 	'description' => 'Action to edit groups', 	'title' => 'Update Group', 											])
            ->create([	'id' => '803230', 	'resource' => '800503', 	'name' => 'EditCategoryFormAction', 	'description' => 'Action to edit categories', 	'title' => 'Update Category', 											])
            ->create([	'id' => '803231', 	'resource' => '800506', 	'name' => 'EditTaskFormAction', 	'description' => 'Action to edit Tasks', 	'title' => 'Update Task', 											])
            ->create([	'id' => '803232', 	'resource' => '800508', 	'name' => 'ListPartnerProfile', 	'description' => 'Action to list profile', 			'menu' => 'My Profile', 									])
            ->create([	'id' => '803233', 	'resource' => '800508', 	'name' => 'EditProfileAction', 	'description' => 'Action to edit partner', 	'title' => 'Update Profile Details', 											])
            ...
            ->create([	'id' => '803235', 	'resource' => '800506', 	'name' => 'CreateTaskGroup', 	'description' => 'Action to call a form to create a task group', 			'menu' => 'Create Group', 									])
            ->create([	'id' => '803236', 	'resource' => '800506', 	'name' => 'ListAllTaskGroups', 	'description' => 'Action to list all task groups', 			'menu' => 'List All Groups', 									])
            ->create([	'id' => '803237', 	'resource' => '800506', 	'name' => 'EditTaskGroupDetails', 	'description' => 'Action to update task group details', 	'title' => 'Update Group Details', 											])
            ->create([	'id' => '803238', 	'resource' => '800506', 	'name' => 'AssignTaskGroup', 	'description' => 'Action to assign tasks to any groups', 	'title' => 'Manage Task Groups', 											])
            ->create([	'id' => '803239', 	'resource' => '800506', 	'name' => 'AssignGroupTasks', 	'description' => 'Action to manage tasks for a group', 	'title' => 'Manage Group Tasks', 											])
            ->create([	'id' => '803240', 	'resource' => '800506', 	'name' => 'AssignPartnerGroups', 	'description' => 'Action to assign partner group to a task group', 	'title' => 'Assign Partner Groups', 											])
            ->create([	'id' => '803241', 	'resource' => '800501', 	'name' => 'AssignTaskGroups', 	'description' => 'Action to assign task group to a partner group', 	'title' => 'Assign Task Groups', 											])
            ->create([	'id' => '803242', 	'resource' => '800501', 	'name' => 'ManagePartnerTasks', 	'description' => 'Action to add or remove tasks of a partner', 	'title' => 'Add/Remove Tasks', 											])
        ;
