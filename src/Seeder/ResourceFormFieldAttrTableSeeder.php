...
class ResourceFormFieldAttrTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\ResourceFormFieldAttr::query()
            ...
            ->create([	'id' => '801313', 	'form_field' => '801012', 	'name' => 'value', 	'value' => 'Completed', 												])
            ->create([	'id' => '801314', 	'form_field' => '801013', 	'name' => 'inline', 	'value' => '4', 												])
            ->create([	'id' => '801315', 	'form_field' => '801014', 	'name' => 'inline', 	'value' => '4', 												])
            ->create([	'id' => '801316', 	'form_field' => '801015', 	'name' => 'inline', 	'value' => '4', 												])
            ->create([	'id' => '801317', 	'form_field' => '801016', 	'name' => 'inline', 	'value' => '4', 												])
            ->create([	'id' => '801318', 	'form_field' => '801016', 	'name' => 'value', 	'value' => 'Completed', 												])
            ->create([	'id' => '801319', 	'form_field' => '801017', 	'name' => 'inline', 	'value' => '4', 												])
            ->create([	'id' => '801320', 	'form_field' => '801021', 	'name' => 'inline', 	'value' => '4', 												])
            ->create([	'id' => '801321', 	'form_field' => '801022', 	'name' => 'inline', 	'value' => '4', 												])
            ->create([	'id' => '801322', 	'form_field' => '801023', 	'name' => 'inline', 	'value' => '4', 												])
            ->create([	'id' => '801323', 	'form_field' => '801023', 	'name' => 'value', 	'value' => 'Dismissed', 												])
            ->create([	'id' => '801324', 	'form_field' => '801024', 	'name' => 'inline', 	'value' => '4', 												])
            ...
            ->create([	'id' => '801332', 	'form_field' => '801034', 	'name' => 'inline', 	'value' => '4', 												])
            ->create([	'id' => '801333', 	'form_field' => '801035', 	'name' => 'inline', 	'value' => '4', 												])
        ;
