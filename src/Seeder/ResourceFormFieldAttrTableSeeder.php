...
class ResourceFormFieldAttrTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\ResourceFormFieldAttr::query()
            ...
            ->create([	'id' => '801309', 	'form_field' => '801010', 	'name' => 'inline', 	'value' => '4', 												])
            ->create([	'id' => '801310', 	'form_field' => '801009', 	'name' => 'inline', 	'value' => '4', 												])
            ...
            ->create([	'id' => '801314', 	'form_field' => '801013', 	'name' => 'value', 	'value' => 'Completed', 												])
            ...
            ->create([	'id' => '801319', 	'form_field' => '801017', 	'name' => 'value', 	'value' => 'Completed', 												])
            ->create([	'id' => '801320', 	'form_field' => '801018', 	'name' => 'inline', 	'value' => '4', 												])
