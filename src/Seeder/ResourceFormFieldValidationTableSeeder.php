...
class ResourceFormFieldValidationTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\ResourceFormFieldValidation::query()
            ...
            ->create([	'id' => '801507', 	'form_field' => '801016', 	'rule' => 'required', 	'message' => 'Set new status', 												])
            ->create([	'id' => '801508', 	'form_field' => '801017', 	'rule' => 'required', 	'message' => 'Remarks required', 												])
            ->create([	'id' => '801509', 	'form_field' => '801022', 	'rule' => 'required', 	'message' => 'Need atleast one attachment', 												])
            ->create([	'id' => '801510', 	'form_field' => '801028', 	'rule' => 'required', 	'message' => 'Remarks is mandatory', 												])
        ;
