...
class ResourceFormFieldValidationTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\ResourceFormFieldValidation::query()
            ...
            ->create([	'id' => '801507', 	'form_field' => '801012', 	'rule' => 'required', 	'message' => 'Set new status', 												])
            ->create([	'id' => '801508', 	'form_field' => '801013', 	'rule' => 'required', 	'message' => 'Remarks required', 												])
            ->create([	'id' => '801509', 	'form_field' => '801024', 	'rule' => 'required', 	'message' => 'Remarks is mandatory', 												])
        ;
